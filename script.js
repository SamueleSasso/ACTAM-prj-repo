...
const presets = {
    dub_techno: {
        ...
        tracks: [
            ...
            { steps: 16, pulses: 3, offset: 3, sample: 'LowTom', adsr: { attack: 0.05, decay: 0.1, sustain: 0.7, release: 1.0 } },
            { steps: 16, pulses: 4, offset: 2, sample: 'Ride', adsr: { attack: 0.02, decay: 0.1, sustain: 0.3, release: 0.0 } },
            { steps: 12, pulses: 4, offset: 5, sample: 'RimShot', adsr: { attack: 0.001, decay: 0.05, sustain: 0.1, release: 0.05 } }
        ]
    },
    minimal: {
        ...
        tracks: [
            ...
            { steps: 13, pulses: 2, offset: 2, sample: 'ClosedHat', adsr: { attack: 0.001, decay: 0.03, sustain: 0.0, release: 0.03 } },
            { steps: 32, pulses: 1, offset: 31, sample: 'MidTom', adsr: { attack: 0.01, decay: 0.1, sustain: 0.2, release: 0.1 } }
        ]
    },
    hypnotic: {
        bpm: 130,
        tracks: [
            { steps: 16, pulses: 4, offset: 0, sample: 'Kick', adsr: { attack: 0.01, decay: 0.3, sustain: 0.8, release: 0.4 } },
            { steps: 16, pulses: 11, offset: 0, sample: 'Ride', adsr: { attack: 0.01, decay: 0.1, sustain: 0.01, release: 0.01 } },
            { steps: 16, pulses: 3, offset: 2, sample: 'LowTom', adsr: { attack: 0.001, decay: 0.04, sustain: 0.1, release: 0.02 } },
            { steps: 16, pulses: 3, offset: 11, sample: 'RimShot', adsr: { attack: 0.001, decay: 0.05, sustain: 0.2, release: 0.05 } }
        ]
    },
    jungle: {
    ...
    tarantella: {
        ...
        tracks: [
            ...
            { steps: 12, pulses: 6, offset: 1, sample: 'RimShot', adsr: { attack: 0.001, decay: 0.05, sustain: 0.2, release: 0.05 } },
            { steps: 12, pulses: 9, offset: 0, sample: 'ClosedHat', adsr: { attack: 0.001, decay: 0.03, sustain: 0.01, release: 0.5 } },
    ...
    reggae: {
        ...
        tracks: [
            ...
            { steps: 16, pulses: 8, offset: 2, sample: 'ClosedHat', adsr: { attack: 0.05, decay: 0.05, sustain: 0.1, release: 0.05 } },
